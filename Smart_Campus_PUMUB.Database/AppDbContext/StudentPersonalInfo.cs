...
public class StudentPersonalInfo
{
    ...
    [NotMapped]
    public string? FullName { get { return student_name_en; } set { student_name_en = value; } }
    [NotMapped]
    public string? Email { get { return email; } set { email = value; } }
    [NotMapped]
    public string? Phone { get { return app_student_phone; } set { app_student_phone = value; } }
    [NotMapped]
    public string? FormNo { get { return AdmissionSerialNo; } set { AdmissionSerialNo = value; } }
    [NotMapped]
    public string? ExamSeatNo { get { return university_reg_no; } set { university_reg_no = value; } }

    public DateTime? CreatedDateTime { get; set; } = DateTime.UtcNow.AddHours(6).AddMinutes(30);
    public DateTime? ModifiedDateTime { get; set; } = DateTime.UtcNow.AddHours(6).AddMinutes(30);
}
